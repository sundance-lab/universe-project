...
export const HexPlanetViewController = (() => {
    ...
    function initScene(canvas, planetBasis) {
        ...
        // --- FIX: Completed the detailLevels array ---
        const detailLevels = [
            { subdivision: 128, distance: 2.5 },
            { subdivision: 64,  distance: 3.5 },
            { subdivision: 32,  distance: 5.0 },
            { subdivision: 16,  distance: 8.0 },
            { subdivision: 8,   distance: 12.0 },
            { subdivision: 4,   distance: 20.0 }
        ];
