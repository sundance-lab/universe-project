...
export class SunRenderer {
 ...
 #createSun = () => {
    ...
    // Use the CORRECT, original sun surface shader with snoise
    const sunMaterial = new THREE.ShaderMaterial({
        ...
        // FIX: Use backticks (`) for multi-line GLSL strings
        vertexShader: `
            varying vec2 vUv;
            void main() {
                vUv = uv;
        ...
        `,
        // FIX: Restore the correct complex fragment shader for the sun's surface
        fragmentShader: `
            uniform float time;
            uniform vec3 color;
    ...
    const coronaMaterial = new THREE.ShaderMaterial({
        ...
        // FIX: Use backticks for the corona shaders as well
        vertexShader: `
            varying vec2 vUv;
            void main() {
                vUv = uv;
        ...
        fragmentShader: `
            ...
            void main() {
                float dist = length(vUv - vec2(0.5));
                float alpha = smoothstep(0.5, 0.1, dist) * 0.3;
